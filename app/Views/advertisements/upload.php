        ...
        Dropzone.options.uploadForm = {
            ...
            init: function() {
                ...
                this.on("queuecomplete", function() {
                    document.getElementById("newAdButton").style.display = "block";
                });
            }
        };
    </script>
...
<body>
    ...
    <button id="newAdButton" style="display: none; margin-top: 20px;" onclick="window.location.href='<?= site_url('advertisements/create') ?>'">
        Nuevo Anuncio
    </button>
</body>
</html>
